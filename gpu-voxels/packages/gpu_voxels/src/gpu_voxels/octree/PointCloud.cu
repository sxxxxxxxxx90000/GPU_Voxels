...
#include <cub/device/device_radix_sort.cuh> // for cuda 11
// #undef CUB_NS_PREFIX // comment out for cuda 11
// #undef CUB_NS_POSTFIX // comment out for cuda 11
// namespace cub = thrust::cuda_cub::cub; // comment out for cuda 11
#endif
